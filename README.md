...
- [translate:Gin] — веб-фреймворк для создания HTTP-сервисов  
- [translate:Swagger] — генерация и документация REST API  
- [translate:testify] — библиотека для написания тестов и утверждений (assertions)  
- [translate:golangci-lint] — комплексный линтер для проверки качества кода  
- [translate:migrate] — управление миграциями базы данных

**Базы данных и контейнеры:**  
- [translate:PostgreSQL] — реляционная база данных  
- [translate:Docker] — контейнеризация приложений и служб  
